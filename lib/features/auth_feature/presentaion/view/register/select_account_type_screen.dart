          ...
          builder: (context, state) {
            return Padding(
              ...
              child: Column(
                ...
                children: [
                  CreateAccountCustomBar(fillItems: 1, haveBackButton: false),
                  24.verticalSpace,
                  Text(
                    ...
                    child: GridView.builder(
                      ...
                      itemBuilder: (context, index) {
                        return AccountTypeItem(
                          ...
                          isSelected:
                              state.registerModel.userTypeId != null &&
                              state.registerModel.userTypeId ==
                                  state.accountTypes[index].userTypeId,
                          onTap: () {
                            log('Selected: ${state.accountTypes[index].label}');
                            context.read<RegistrationCubit>().setSelectedType(
                              state.accountTypes[index].userTypeId,
                            );
                          },
                        );
                  ...
                  CustomButton(
                    ...
                    onPressed: () {
                      log("${state.registerModel.userTypeId}");
                      if (state.registerModel.userTypeId != null) {
                        ...
                        Navigator.push(
                          context,
                          MaterialPageRoute(
                            builder: (con) => RegisterView(
                              registerCubit: context.read<RegistrationCubit>(),
                            ),
                          ),
                        );
                      } else {
                        MessageService.showToast(
                          msg: "Must select your type",
