...
class _BookAppointmentServices implements BookAppointmentServices {
  _BookAppointmentServices(this._dio, {this.baseUrl, this.errorLogger});
  ...
  @override
  Future<BaseResponseModel<dynamic>> bookAppointment({
    ...
    final _options = _setStreamType<BaseResponseModel<dynamic>>(
      Options(method: 'POST', headers: _headers, extra: _extra)
          .compose(
            _dio.options,
            'Account/BookAppointmententicate',
