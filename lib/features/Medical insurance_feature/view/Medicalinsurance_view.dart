...
class _MedicalInsuranceScreenState extends State<MedicalInsuranceScreen> {
  ...
  Widget build(BuildContext context) {
    return Scaffold(
      appBar: CustomAppBar(title: context.translate.medicalInsurance),
      body: Padding(
          ...
          children: [
            ...
            Container(
              ...
              child: _selectedImage == null
                  ? Center(
                      child: Text(context.translate.noImageSelected,
            ...
            TextButton.icon(
              ...
              label: Text(
                context.translate.addAnotherImage,
            ...
            SizedBox(
              width: double.infinity,
              child: CustomButton(
                title: context.translate.saveEdit,
                onPressed: () {
